...
* SQLmap_GUI use the default pass of SQLmap : /usr/share/sqlmap/sqlmap.py. This is the same pass under kalilinux. You must install or re-copy SQLmap to this directory.
